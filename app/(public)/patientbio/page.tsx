...
export default function PatientBioPage() {
    ...
    return (
        <div className="relative max-w-2xl mx-auto bg-white shadow-md rounded-md p-12 mt-10 transition-all duration-700 animate-fade-in">
            {/* 中左大圓形證件照 */}
            ...
            >
                ...
                <button
                    type="submit"
                    className="w-full bg-green-600 text-white py-2 rounded-md hover:bg-green-700 transition active:scale-95"
                >
                    儲存
                </button>
            </form>
